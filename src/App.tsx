...
function App() {
  ...
  const handleSubmit = React.useCallback(
    async () => {
      try {
        ...
        if (user) await fetchPicks(user.id);
  ...
  }, [user, userProfile, userPicks, isAdmin, authLoading, loading, handleSubmit, handleUnpublish, handleCancelSubmission, location.pathname, navigate]);
