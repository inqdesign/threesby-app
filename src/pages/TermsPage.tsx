            ...
            <div className="min-h-screen bg-gray-50 pb-20">
              ...
              <div className="p-4 md:p-8 flex justify-center">
                <div className="bg-white rounded-xl shadow-sm p-6 w-full max-w-[700px]">
                  <h2 className="text-xl font-semibold mb-4">ThreesBy – Terms and Conditions</h2>
                  ...
                  <div className="prose prose-sm max-w-none">
                    ...
                    <h3 className="font-semibold mt-6 mb-2">1. Who We Are</h3>
                    <p className="text-gray-700">
                    ...
                    <h3 className="font-semibold mt-6 mb-2">2. Eligibility & Accounts</h3>
                    <p className="text-gray-700">
                    ...
                    <h3 className="font-semibold mt-6 mb-2">3. User Content</h3>
                    <p className="text-gray-700">
                    ...
                    <h3 className="font-semibold mt-6 mb-2">4. Brand & Paid Accounts (Coming Soon)</h3>
                    <p className="text-gray-700">
                    ...
                    <h3 className="font-semibold mt-6 mb-2">5. Use of External Content</h3>
                    <p className="text-gray-700">
                    ...
                    <h3 className="font-semibold mt-6 mb-2">6. Platform Rights & Limitations</h3>
                    <p className="text-gray-700">
                      We may:
                    </p>
                    <ul className="list-disc pl-5 mt-2 text-gray-700">
                    ...
                    <h3 className="font-semibold mt-6 mb-2">7. Privacy & Data</h3>
                    <p className="text-gray-700">
                      Your data is handled respectfully and in accordance with applicable data protection laws. For more information, see our <Link to="/privacy-policy" className="text-blue-600 hover:underline">Privacy Policy</Link>.
                    </p>
                    
                    <h3 className="font-semibold mt-6 mb-2">8. Termination</h3>
                    <p className="text-gray-700">
                      You may delete your account at any time. We may suspend or terminate accounts that violate these terms.
                    </p>
                    
                    <h3 className="font-semibold mt-6 mb-2">9. Governing Law</h3>
                    <p className="text-gray-700">
                      These terms are governed by the laws of South Korea. Any legal disputes must be resolved in that jurisdiction.
                    </p>
                    
                    <h3 className="font-semibold mt-6 mb-2">10. Contact</h3>
                    <p className="text-gray-700">
