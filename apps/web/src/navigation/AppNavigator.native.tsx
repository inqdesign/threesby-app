...
import { View, Text, StyleSheet } from '../platform/native';
...
const PickDetailScreen = () => (
  <View style={styles.placeholderScreen}>
    <Text style={styles.placeholderText}>Pick Detail</Text>
  </View>
);

const CollectionDetailScreen = () => (
  <View style={styles.placeholderScreen}>
    <Text style={styles.placeholderText}>Collection Detail</Text>
  </View>
);
...
const EditPickScreen = () => (
  <View style={styles.placeholderScreen}>
    <Text style={styles.placeholderText}>Edit Pick</Text>
  </View>
);
