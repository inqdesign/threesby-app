/*
  # Create Featured Picks Table with Trigger-Based Limit
...
DROP POLICY IF EXISTS "Admins can manage featured picks" ON featured_picks;
DROP POLICY IF EXISTS "Anyone can read featured picks" ON featured_picks;
